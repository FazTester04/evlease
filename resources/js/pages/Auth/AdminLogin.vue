                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center">
                                <input
                                    ...
                                    type="checkbox"
                                    class="h-4 w-4 rounded border-slate-600 bg-slate-700/50 text-orange-600 focus:ring-orange-500"
                                />
                            ...
                            >
                                ...
                                {{ form.processing ? 'Authenticating...' : 'Access System' }}
                            </Button>
                            ...
                            <div class="border-t border-slate-700 pt-6 text-center">
                                <div class="flex items-center justify-center space-x-2 text-slate-400">
                                    ...
                                    <p class="text-xs">Secure connection established</p>
                                </div>
